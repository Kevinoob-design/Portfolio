        ...
        <div className="px-4 text-base">
            <div className="mx-auto max-w-lg shadow-2xl rounded md:p-10 p-5 text-center border-t-4 border-blue-600">
                ...
                <form className="flex flex-wrap justify-center" action="/api/contact" method="post">
                    ...
                    <input name="Subject" autocomplete="off" required id="Subject" className="rounded bg-gray-800 shadow-2xl w-full flex-grow mx-auto my-3 mx-1 p-1" placeholder="Just a subject..." type="text"/>
                    ...
                    <input name="ContactEmail" autocomplete="off" required className="rounded bg-gray-800 shadow-2xl my-3 mx-1 p-1 block mx-auto w-2/3 flex-grow" placeholder="email@examble.com" type="email" /> 
