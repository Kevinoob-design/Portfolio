...
function AboutCard(props){
    return (
        <div className="aboutCard relative w-1/5 flex-grow md:mx-1 md:my-5 my-2 bg-gray-900 p-2" to={props.params.link}>
            <div className={"h-full rounded shadow-xl border-t-4 " + props.params.color} data-aos={props.params.animation} data-aos-mirror={false} data-aos-once={true} data-aos-duration="600">
